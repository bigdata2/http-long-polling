...
class Stack(Protocol):
    """
    Stack protocol class that implements the functionality of the stack server.
    Functions from this class are called when a TCP socket connection is made, 
    and closed and when data from socket is received. 
    """
    ...
    def connectionMade(self):
        """
        Automatically called by twisted when a TCP connection is made.
        This function initializes the Twisted protocol and is called 
        when a socket has been received.
        """
    ...
    def connectionLost(self, reason):
        """
        Called when the TCP connection for this protocol instance is closed 
        either by the client or the stack server.
        """
...
class StackFactory(Factory):
    """
    This is a factory which builds protocol instancess to handle 
